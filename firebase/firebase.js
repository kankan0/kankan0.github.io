...
(function () {
  ...
  }, h = "undefined" != typeof window && window === this ? this : "undefined" != typeof global ? global : this, l = function () {
    l = function () {
    };
...
(function () {
  ...
  var db = y("Opera"), z = y("Trident") || y("MSIE"), eb = y("Edge"), fb = eb || z, gb = y("Gecko") && !(v(Ya.toLowerCase(), "webkit") && !y("Edge")) && !(y("Trident") || y("MSIE")) && !y("Edge"), hb = v(Ya.toLowerCase(), "webkit") && !y("Edge"), ib = function () {
    var a = l.document;
  ...
  var mc = function (a) {
    ...
    "\t": "\\t",
    "\x0B": "\\u000b"
  }, sc = /\uffff/.test("\uffff") ? /[\\\"\x00-\x1f\x7f-\uffff]/g : /[\\\"\x00-\x1f\x7f-\xff]/g, qc = function (a, b) {
  ...
  var xe = /^(?:([^:/?#.]+):)?(?:\/\/(?:([^/?#]*)@)?([^/#?]*?)(?::([0-9]+))?(?=[/#?]|$))?([^?#]+)?(?:\?([^#]*))?(?:#([\s\S]*))?$/, ye = function (a, b) {
    if (a) {
      a = a.split("&");
  ...
  var T = function (a, b, c) {
    ...
    this.Sd = new yc;
    this.Ke = new ag(d)
  }, dg, bg = {"Content-Type": "application/x-www-form-urlencoded"}, cg = {"Content-Type": "application/json"}, fg = function (a, b, c, d, e, f, g) {
  ...
  var Dg = {endpoint: "setAccountInfo", D: Ag, cb: "email"}, Cg = {
    ...
    }, og = {Rd: !0, endpoint: "getProjectConfig", je: "GET"}, Bg = {
    ...
    }, rg = {endpoint: "signupNewUser", sa: qg, ta: !0}, Nf = {
  ...
  var Xg = function () {
    ...
    var a = "Node" == qf(), a = l.localStorage || a && firebase.INTERNAL.node && firebase.INTERNAL.node.localStorage;
    if (!a)return !1;
    try {
  ...
  var $g = function () {
    ...
    var a = "Node" == qf(), a = l.sessionStorage || a && firebase.INTERNAL.node && firebase.INTERNAL.node.sessionStorage;
    if (!a)return !1;
    try {
      return a.setItem("__sak", "1"), a.removeItem("__sak"), !0
    } catch (b) {
...
(function () {
  ...
  function ab(a, b) {
    ...
    for (var c = b ? Za : Ya, d = [], e = 0; e < a.length; e += 3) {
      var f = a[e], g = e + 1 < a.length, k = g ? a[e + 1] : 0, m = e + 2 < a.length, l = m ? a[e + 2] : 0, u = f >> 2, f = (f & 3) << 4 | k >> 4, k = (k & 15) << 2 | l >> 6, l = l & 63;
      m || (l = 64, g || (k = 64));
  ...
  function Ef(a, b, c) {
    ...
    if (ha(b)) {
      var d = !1, e = !1;
      Cb(b, function (b, g) {
        if (".value" === b)d = !0; else if (".priority" !== b && ".sv" !== b && (e = !0, !Bf(b)))throw Error(a + " contains an invalid key (" + b + ") " + qf(c) + '.  Keys must be non-empty strings and can\'t contain ".", "#", "$", "/", "[", or "]"');
        c.push(b);
        Ef(a, g, c);
        c.pop()
      });
  ...
  function Ah(a) {
    if (Bh(a)) {
      ...
      a.Bc = null;
      var b = r(a.wd, a), c = r(a.Mc, a), d = r(a.jf, a), e = a.id + ":" + qh++, f = a.Db, g = !1, k = null, m = function () {
        k ? k.close() : (g = !0, d())
      };
      a.Ia = {
...
(function () {
  ...
  var ta = {STATE_CHANGED: "state_changed"}, ua = {
    RUNNING: "running",
    PAUSED: "paused",
    SUCCESS: "success",
    CANCELED: "canceled",
  ...
  u($b, Pb);
  var ac = C("Opera"), D = C("Trident") || C("MSIE"), bc = C("Edge"), dc = C("Gecko") && !(-1 != ib.toLowerCase().indexOf("webkit") && !C("Edge")) && !(C("Trident") || C("MSIE")) && !C("Edge"), ec = -1 != ib.toLowerCase().indexOf("webkit") && !C("Edge"), fc = function () {
    var a = m.document;
    return a ? a.documentMode : void 0
  }, gc;
  a:{
  ...
  k.ua = function (a) {
    ...
    return de(this.b).then(function (c) {
      var d = b.b, e = b.a, f = a, g = ge(), h = Ra(e), h = ka + "/v0" + h, f = ie(f, g), d = new w(h, "PATCH", re(d, g), d.c);
